...
import {
  OverlayEventBus,
  script as script7
} from "./chunk-4TBZFVVH.js";
import {
  script as script6
} from "./chunk-7Y3UQZMG.js";
import {
  script as script5
...
var script14 = {
  ...
  methods: {
    ...
    getOptionRenderKey: function getOptionRenderKey(option2, index) {
      return (this.dataKey ? ObjectUtils.resolveFieldData(option2, this.dataKey) : this.getOptionLabel(option2)) + "_" + index;
    },
    ...
    isSelected: function isSelected(option2) {
      return this.isValidOption(option2) && ObjectUtils.equals(this.modelValue, this.getOptionValue(option2), this.equalityKey);
    },
    ...
    findPrevOptionIndex: function findPrevOptionIndex(index) {
      var _this10 = this;
      var matchedOptionIndex = index > 0 ? ObjectUtils.findLastIndex(this.visibleOptions.slice(0, index), function(option2) {
